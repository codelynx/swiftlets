...
# Compile the standalone version that works
compile_swiftlet "src/index-standalone.swift" "$BIN_DIR/index"

echo -e "${GREEN}Build complete!${NC}"
echo ""
echo "To run the site:"
echo "  cd ../../.. && SWIFTLETS_SITE=sdk/sites/swiftlets-site ./core/.build/release/swiftlets-server"