...
struct TextFormattingShowcase: SwiftletMain {
    ...
    @HTMLBuilder
    func basicTextFormatting() -> some HTMLElement {
        CodeExample(
    ...
    @HTMLBuilder
    func codeAndPreformatted() -> some HTMLElement {
        CodeExample(
    ...
    @HTMLBuilder
    func quotations() -> some HTMLElement {
        CodeExample(
            title: "Quotations",
            swift: """
            // Block quote
    ...
    @HTMLBuilder
    func subscriptSuperscript() -> some HTMLElement {
        CodeExample(
    ...
    @HTMLBuilder
    func insertionsDeletions() -> some HTMLElement {
        CodeExample(
    ...
    @HTMLBuilder
    func abbreviationsDefinitions() -> some HTMLElement {
        CodeExample(
    ...
    @HTMLBuilder
    func specialTextElements() -> some HTMLElement {
        CodeExample(
